...
public class FirstPersonView : MonoBehaviour
{
...

    {
        ...
        if (!m_IsStreamStarted)
        {
            ...
            {
                NRDebugger.Info("[FPStreammingCast] Get the server result:{0} ip:{1}", result.isSuccess,
    ...
    void OnStartedVideoCaptureMode(NRVideoCapture.VideoCaptureResult result)
    {
        ...
        m_VideoCapture.GetContext().GetBehaviour().CaptureCamera.backgroundColor =
            useGreenBackGround ? Color.green : Color.black;
    }
